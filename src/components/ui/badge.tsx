...
const badgeVariants = cva(
  "inline-flex items-center whitespace-nowrap rounded-full border [&_svg]:shrink-0 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50",
  {
    variants: {
      variant: {
        default:
