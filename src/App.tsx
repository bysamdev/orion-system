...
const InfrastructureDashboard = lazyWithRetry(() => import("./pages/InfrastructureDashboard"));
...
const TicketHistory = lazyWithRetry(() => import("./pages/TicketHistory"));
...
const PatchManagement = lazyWithRetry(() => import("./pages/PatchManagement"));
const Notifications = lazyWithRetry(() => import("./pages/Notifications"));
const WebMonitoring = lazyWithRetry(() => import("./pages/WebMonitoring"));
...
/** Wrapper: ProtectedRoute + DashboardLayout compartilhado + ErrorBoundary por rota */
    ...
    <ThemeProvider defaultTheme="system">
      ...
      <AuthProvider>
        <TooltipProvider>
          ...
          <BrowserRouter>
            <RootErrorBoundary>
              <Suspense fallback={<RouteLoadingFallback message="Carregando módulo..." />}>
                <Routes>
                  ...
                  <Route path="/central-alertas" element={<AppRoute allowedRoles={['admin', 'developer', 'technician']}><AlertsDashboard /></AppRoute>} />
                  ...
                  <Route path="/automacoes" element={<AppRoute allowedRoles={['admin', 'developer', 'technician']}><Automacoes /></AppRoute>} />
